...
//    }
    ...
    public List<Menu> createTestMenus() {
    ...
    private Dish createDish(String id, String menuId, String name, String description, double price, String category, int salesVolume) {
        Dish dish = new Dish();
        dish.setId(id);
        dish.setName(name);
    ...
    private void addCrust(Dish dish, boolean isRequired) {
    ...
    private void addSpiciness(Dish dish, boolean isRequired) {
    ...
    private void addToppings(Dish dish, boolean isRequired) {
    ...
    private void addMexicanToppings(Dish dish) {
        DishAttribute toppings = new DishAttribute();
        toppings.setName("Toppings");
    ...
    private void addSushiToppings(Dish dish) {
        DishAttribute toppings = new DishAttribute();
        toppings.setName("Toppings");
    ...
    private void addRamenSpiciness(Dish dish) {
        DishAttribute spiciness = new DishAttribute();
        spiciness.setName("Spiciness");
    ...
    private void addIceOptions(Dish dish) {
    ...
    private void addSugarOptions(Dish dish) {
    ...
    private void addTeaBaseOptions(Dish dish) {
    ...
    private void addToppingsOptions(Dish dish) {
        DishAttribute toppings = new DishAttribute();
